...
class DebugCron
{
    ...
    public function user_constants()
    {
        $defined_constants = get_defined_constants(true);
        $user_constants = $defined_constants['user'];
        unset( $defined_constants, $user_constants['DB_PASSWORD'] );
        $this->addMessage( sprintf('<xmp>%s</xmp>', var_export($user_constants, true) ) );
    }
